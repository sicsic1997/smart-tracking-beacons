...
describe('Service Tests', () => {
    describe('Beacon Service', () => {
        ...
        beforeEach(() => {
            ...
            elemDefault = new Beacon(0, 'AAAAAAA');
        });
        ...
        describe('Service methods', async () => {
            ...
            it('should create a Beacon', async () => {
            ...
            it('should update a Beacon', async () => {
                const returnedFromService = Object.assign(
                    {
                        uuid: 'BBBBBB'
                    },
            ...
            it('should return a list of Beacon', async () => {
                const returnedFromService = Object.assign(
                    {
                        uuid: 'BBBBBB'
                    },
